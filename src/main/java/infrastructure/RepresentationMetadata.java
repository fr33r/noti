...
public class RepresentationMetadata {
    ...
    public RepresentationMetadata(
		...
		if(contentLocation == null) {
			throw new IllegalArgumentException("The constructor argument 'contentLocation' cannot be null.");
		}
     ...
     */
	public URI getContentLocation(){ return this.contentLocation; }
     ...
     * last modified.
     */
	public MediaType getContentType(){ return this.contentType; }

	public Locale getContentLanguage() { return this.contentLanguage; }
     ...
     * last modified.
     */
	public Date getLastModified(){ return this.lastModified == null ? null : (Date)this.lastModified.clone(); }
     ...
     */
	public EntityTag getEntityTag(){ return this.entityTag; }

    /**
     * Determines if a provided object is semantically
     * equivalent to the calling RepresentationMetadata instance.
     * @param object An instance of Object to be compared with
     *               the calling RepresentationMetadata instance.
     * @return true if the Object instance provided is an instance
     * of RepresentationMetadata and is semantically equivalent to the calling
     * RepresentationMetadata instance; false otherwise.
     */
	@Override
     ...
     * calling RepresentationMetadata instance.
     * @return The hashcode of the calling RepresentationMetadata instance.
     */
    @Override
	public int hashCode() {
		final int prime = 31;
    ...
    /**
     * Creates a string representation of the calling RepresentationMetadata instance.
     * @return A string representation of the calling RepresentationMetadata instance.
     */
	@Override
