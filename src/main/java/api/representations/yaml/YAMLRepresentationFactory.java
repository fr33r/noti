 ...
 * @author Jon Freer
 */
@Named("YAMLRepresentationFactory")
public final class YAMLRepresentationFactory extends RepresentationFactory {

  private final Tracer tracer;

  /**
   * Constructs a new {@link YAMLRepresentationFactory}.
   *
   * @param tracer The tracer conforming to the OpenTracing standard utilized for instrumentation.
   */
  @Inject
  public YAMLRepresentationFactory(Tracer tracer) {
  ...
  public Representation createNotificationRepresentation(
    ...
    Span span =
        this.tracer
            .buildSpan("YAMLRepresentationFactory#createNotificationRepresentation")
  ...
  public Representation createAudienceRepresentation(
    ...
    Span span =
        this.tracer
            .buildSpan("YAMLRepresentationFactory#createAudienceRepresentation")
            .asChildOf(this.tracer.activeSpan())
            .start();
    try (Scope scope = this.tracer.scopeManager().activate(span, false)) {
      Set<api.representations.json.Target> targets = new HashSet<>();
  ...
  public Representation createTargetRepresentation(URI location, Locale language, Target target) {
    Span span =
        this.tracer
            .buildSpan("YAMLRepresentationFactory#createTargetRepresentation")
            .asChildOf(this.tracer.activeSpan())
            .start();
    try (Scope scope = this.tracer.scopeManager().activate(span, false)) {
      api.representations.Representation representation =
  ...
  public Representation createMessageRepresentation(
    ...
    Span span =
        this.tracer
            .buildSpan("YAMLRepresentationFactory#createMessageRepresentation")
            .asChildOf(this.tracer.activeSpan())
            .start();
    try (Scope scope = this.tracer.scopeManager().activate(span, false)) {
  ...
  public Representation createNotificationCollectionRepresentation(
    ...
    Span span =
        this.tracer
            .buildSpan("YAMLRepresentationFactory#createNotificationCollectionRepresentation")
            .asChildOf(this.tracer.activeSpan())
            .start();
    try (Scope scope = this.tracer.scopeManager().activate(span, false)) {
  ...
  public Representation createTargetCollectionRepresentation(
    ...
    Span span =
        this.tracer
            .buildSpan("YAMLRepresentationFactory#createTargetCollectionRepresentation")
            .asChildOf(this.tracer.activeSpan())
            .start();
    try (Scope scope = this.tracer.scopeManager().activate(span, false)) {
  ...
  public Representation createAudienceCollectionRepresentation(
    ...
    Span span =
        this.tracer
            .buildSpan("YAMLRepresentationFactory#createAudienceCollectionRepresentation")
            .asChildOf(this.tracer.activeSpan())
            .start();
    try (Scope scope = this.tracer.scopeManager().activate(span, false)) {
  ...
  public Representation createMessageCollectionRepresentation(
    ...
    Span span =
        this.tracer
            .buildSpan("YAMLRepresentationFactory#createMessageCollectionRepresentation")
            .asChildOf(this.tracer.activeSpan())
            .start();
    try (Scope scope = this.tracer.scopeManager().activate(span, false)) {
