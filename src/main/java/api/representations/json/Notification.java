...
public final class Notification extends Representation {
	...
	public static final class Builder extends Representation.Builder {
		...
		public Builder sentAt(Date sentAt) { this.sentAt = sentAt; return this; }

		public Builder sendAt(Date sendAt) { this.sendAt = sendAt; return this; }

		public Builder addTarget(Target target) { this.targets.add(target); return this; }

		public Builder targets(Set<Target> targets) { this.targets = targets; return this; }

		public Builder addAudience(Audience audience) { this.audiences.add(audience); return this; }

		public Builder audiences(Set<Audience> audiences) { this.audiences = audiences; return this; }
