...
public class Representation {
	 ...
	 * <see> 
	 * The
	 *  <a href='https://tools.ietf.org/html/rfc7231#section-3.1.4.2'>Content-Location</a>
	 ...
	 * <see>
	 * The 
	 *  <a href='https://tools.ietf.org/html/rfc7232#section-2.3'>ETag</a>
	 * header as described in RFC7231.
	 * </see>
	 *
	 ...
	 * </see>
	 * <see>
	 *  <a href='https://tools.ietf.org/html/rfc7231#section-3.1.2.1'>Content codings</a>
	 *  as described in RFC7231.
	 * </see>
	 *
	 ...
	 * <see>
	 * The 
	 *  <a href='https://tools.ietf.org/html/rfc7231#section-3.1.3.2'>Content-Language</a>
	 * header as discussed in RFC7231.
	 * </see>
	 * <see> 
	 *  <a href='https://tools.ietf.org/html/rfc7231#section-3.1.3.1'>Language tags</a>
	...
	/**
	 * Retrieves the date and time that this representation was last modified.
	 * Note - the date and time that the representation was last modified might not
	 * be known, since this information may not be tracked for the representation 
	 * (in the event that a representation metadata store cannot be accessed, for example).
	 * Therefore, client code should not expect every representation to return a not non-null
	 * value for this method.
	 * Note - the date and time by the HTTP RFC only has a one-second time granularity. It
	 * is strongly suggested that HTTP clients utilize ETag as it should always be available,
	 * (every representation will have an ETag) and it's more precise.
	 *
	 * <see> reference for Last-Modified header. </see>
	 * <see> reference for ETag header. </see>
	 * <see> reference for HTTP RFC. </see>
	 * <see> reference for date and time format. </see>
	 *
	 * @return The date and time the representation was last modified (in X format).
	 * In the event that a date and time of when the representation was last modified
	 * is not known, a value of {@code null} will be returned.
	 */
	@JsonIgnore
