...
public interface ResponseContext extends ContainerResponseContext {
	...
	/**
	 * Checks if the HTTP status code of the response is
	 * equivalent to the status code provided.
	 *
	...
	/**
	 * Checks if the HTTP status code of the response belongs
	 * the 'informational' status code class. All HTTP status codes
	 * that start with a '1' belong to the 'informational' class.
	 *
	...
	/**
	 * Checks if the HTTP status code of the response belongs
	 * the 'successful' status code class. All HTTP status codes
	 * that start with a '2' belong to the 'successful' class.
	 *
	...
	/**
	 * Checks if the HTTP status code of the response belongs
	 * the 'redirection' status code class. All HTTP status codes
	 * that start with a '3' belong to the 'redirection' class.
	 *
	...
	/**
	 * Checks if the HTTP status code of the response belongs
	 * the 'client error' status code class. All HTTP status codes
	 * that start with a '4' belong to the 'client error' class.
	 *
	...
	/**
	 * Checks if the HTTP status code of the response belongs
	 * the 'server error' status code class. All HTTP status codes
	 * that start with a '5' belong to the 'server error' class.
	 *
