...
public abstract class Entity<I>{
	...
	/**
	 * Constructor for creating a transient entity. In other words,
	 * this constructor should be used to construct an entity that has
	 * not yet been assigned an identity.
	 */
	public Entity(){
		this.id = null;
	}
	...
	/**
	 * Performs a strongly typed equality comparison
	 * between the calling Entity instance and the provided
	 * Entity instance.
	 * @param entity - The Entity instance to compare to the calling instance.
	 * @return 
	 * 		true if: 	The two instance do not have an identity assigned and
	 * 					have the same memory address.
	 * 					The two instances do have an identity assigned and
	 * 					those identities are equal.
	 * 		false otherwise.
	 */
