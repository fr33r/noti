...
public final class DatabaseModule extends NotiModule {
	...
	public void configure() throws FlywayException {
		...
		final boolean useLegacyDateTimeCode =
			databaseConfiguration.getUseLegacyDatetimeCode();
		final boolean useSSL = databaseConfiguration.getUseSSL();
		final String urlTemplate =
			"jdbc:mysql://%s:%s/%s?useLegacyDatetimeCode=%b&useSSL=%b";
		final String url =
			String.format(urlTemplate, host, port, name, useLegacyDateTimeCode, useSSL);
